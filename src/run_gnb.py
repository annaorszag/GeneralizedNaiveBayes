...
if algorithm == "GNBO":
  ...
  triplet_list, pair_list = get_triplet_list_from_chu_liu(heads, int(max_triplet[1][1:]), int(max_triplet[2][1:]))
elif algorithm == "GNBA":
...
################################################
print("Testing with all the triplets...")
...
################################################
print("Testing and plotting with triplets added one by one...")
data_test_results, accuracy_list, precision_list, recall_list, auc_list = test_results(data_test,
                                                                                      data_train,
                                                                                      triplet_list,
                                                                                      pair_list,
                                                                                      label_pos,
